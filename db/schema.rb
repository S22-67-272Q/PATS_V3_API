...
ActiveRecord::Schema.define(version: 2022_03_22_085235) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "active", default: true
    # Authentication in APIs is be slightly different from 
    # regular Rails applications mainly because the authentication will be **stateless**
    # and we will be using a token (instead of an email and password)
    # We need to add an api_key attribute in the User model and table.
    t.string "api_key"
  end
